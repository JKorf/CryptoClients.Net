...
namespace CryptoClients.Net.UnitTests.Documentation
{
    [TestFixture]
    public class AiExampleCompileTests
    {
        ...
        private static string GetRepositoryRoot()
        {
            ...
            {
                if (File.Exists(Path.Combine(directory.FullName, "CryptoClients.Net.sln")))
                    return directory.FullName;

                directory = directory.Parent;
            }

            throw new DirectoryNotFoundException("Could not find repository root containing CryptoClients.Net.sln.");
        }
    }
}
