...
namespace CryptoClients.Net
{
    ...
    public class CryptoClientsConfiguration
    {
            ...
            Dictionary<Type, List<Delegate>> exchangeConfigurators)
        {
            ...
            Register<CoinExOptions, CoinExRestOptions, CoinExSocketOptions, CoinExEnvironment>(CoinExOptions.Create, Exchange.CoinEx, x => x.Rest, x => x.Socket, CoinExEnvironment.GetEnvironmentByName, x => x.ApiCredentials = GlobalOptions.ApiCredentials?.CoinEx);
