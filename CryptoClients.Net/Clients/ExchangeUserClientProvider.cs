...
namespace CryptoClients.Net.Clients
{
    ...
    public class ExchangeUserClientProvider : IExchangeUserClientProvider
    {
        ...
        private IBitstampUserClientProvider _bitstampProvider;
        ...
        private ICoinGeckoRestClient _coinGeckoRestClient;
        ...
        private ILBankUserClientProvider _lBankProvider;
            ...
            Action<XTOptions>? xtOptions = null)
        {
            ...
            _bitstampProvider = new BitstampUserClientProvider(bitstampOptions);
            ...
            _coinGeckoRestClient = new CoinGeckoRestClient(coinGeckoRestOptions);
            ...
            _lBankProvider = new LBankUserClientProvider(lBankOptions);
            ...
            )
        {
            ...
            _bitstampProvider = bitstampProvider;
            ...
            _coinGeckoRestClient = coinGeckoRestClient;
        ...
        public void ClearUserClients(string userIdentifier, string? exchange = null)
        {
            ...
            if (exchange == null || exchange == Exchange.Bitstamp) _bitstampProvider.ClearUserClients(userIdentifier);
            ...
            if (exchange == null || exchange == Exchange.LBank) _lBankProvider.ClearUserClients(userIdentifier);
        ...
        public IExchangeRestClient GetRestClient(string userIdentifier, ExchangeCredentials? credentials = null, Dictionary<string, string?>? environments = null)
        {
            ...
            var client = new ExchangeRestClient(
                ...
                _bitstampProvider.GetRestClient(userIdentifier, credentials.Bitstamp, environments.TryGetValue(Exchange.Bitstamp, out var bitstampEnv) ? BitstampEnvironment.GetEnvironmentByName(bitstampEnv) : null),
                ...
                _lBankProvider.GetRestClient(userIdentifier, credentials.LBank, environments.TryGetValue(Exchange.LBank, out var lBankEnv) ? LBankEnvironment.GetEnvironmentByName(lBankEnv) : null),
        ...
        public IExchangeSocketClient GetSocketClient(string userIdentifier, ExchangeCredentials? credentials = null, Dictionary<string, string?>? environments = null)
        {
            ...
            var client = new ExchangeSocketClient(
                ...
                _bitstampProvider.GetSocketClient(userIdentifier, credentials.Bitstamp, environments.TryGetValue(Exchange.Bitstamp, out var bitstampEnv) ? BitstampEnvironment.GetEnvironmentByName(bitstampEnv) : null),
                ...
                _lBankProvider.GetSocketClient(userIdentifier, credentials.LBank, environments.TryGetValue(Exchange.LBank, out var lBankEnv) ? LBankEnvironment.GetEnvironmentByName(lBankEnv) : null),
